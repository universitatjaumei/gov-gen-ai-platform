...
class LibraryService:
    ...
    async def get_visible_automations(self, 
                                      client_id: Optional[str] = None, 
                                      partner_id: Optional[str] = None, 
                                      client_groups: List[str] = None, 
                                      is_superadmin: bool = False) -> List[AutomationLibrary]:
        """
        ...
        conditions.append(AutomationLibrary.is_system_template == True)
    ...
    async def delete_automation(self, item_id: str, partner_id: str, is_superadmin: bool = False) -> bool:
        """
