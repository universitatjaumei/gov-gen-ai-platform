...
from server.app.database.models import ClientAccount, ServerSecurityPolicy as SecurityPolicy
...
def partner_security_content(ctx: PartnerContext):
    ...
    # === MAIN CONTENT ===
    ui.label(t('partner.security.title')).classes('text-2xl font-bold mb-6 text-slate-800')
    ...
    with ui.card().classes('w-full p-4 mb-4'):
        with ui.row().classes('w-full justify-between items-center mb-4'):
            with ui.row().classes('items-center gap-2'):
                ...
                ui.label(t('partner.security.general_policy')).classes('text-lg font-bold')
            ui.button(t('admin.common.edit'), icon='edit', on_click=lambda: open_partner_policy_dialog()).props('flat color=primary')
            ...
            with partner_policy_display:
                if using_system:
                    with ui.row().classes('items-center gap-2 mb-4'):
                        ...
                        ui.label(t('admin.security.using_system')).classes('text-sm text-blue-600 italic')
    ...
    with ui.card().classes('w-full p-4'):
        with ui.row().classes('w-full justify-between items-center mb-4'):
            with ui.row().classes('items-center gap-2'):
                ...
                ui.label(t('partner.security.client_policies')).classes('text-lg font-bold')
    ...
    async def refresh_partner_policy():
        async with AsyncSession(server_engine) as session:
            ...
            if policy:
                current_partner_policy['data'] = service._policy_to_dict(policy, "PARTNER")
                current_partner_policy['using_system'] = False
            else:
                # Show system policy as reference
                system_policy = await service.get_system_policy()
                current_partner_policy['data'] = service._policy_to_dict(system_policy, "SYSTEM")
