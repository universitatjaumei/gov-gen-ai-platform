...
| Redacción Contract-First (9R) | 9R.8.1 ✅ | 9R.5.5 | **Opus** | ⏳ En curso — 12 prompts restantes (workflow scripts + CHART + DATA_TRANSFORM + Docling rico insertados tras 9R.5.4) |
...
| Fase 13 — NER reversible en redacción | — | 13.x | Sonnet probable (Opus si reversibilidad se complica) | ⏳ Pendiente — prompts aún no redactados; reutilizará PiiDetector de 9R.5.5 |
| Fase 20 reducida — WCAG transversal | — | 20.1 | Sonnet | ⏳ Pendiente — prompts aún no redactados; aplicación sistemática de patrones de 1C.2 |
...
**Cursor actual: 9R.5.5 — ScriptProposalService + migración anonimización (spaCy+Faker)**
**Modelo sugerido para el próximo prompt: Opus** — migración masiva de código legacy (1011 LOC + 14 tests) con decisiones de diseño embebidas en el camino. Ver convención en CLAUDE.md sección "Modelo por prompt".
