...
| Subfase 1.B — Identidad Visual | — | 10.1 | Sonnet | ⏳ Pendiente — Fase 10 (temas/plantillas) |
| Subfase 1.C — Privacidad, Diseño y Exportación | — | 1C.0 | Sonnet | ⏳ Pendiente — 1C.0, 1C.0.bis (Opus), 1C.1, Fase 13 (NER), 1C.2, 1C.3, 1C.4 |
| Fase 20 reducida — WCAG transversal | — | 20.1 | Sonnet | ⏳ Pendiente — WCAG todas las rutas, sin consola conversacional |
| Fase 11 — Autoinstalación y Distribución | — | 11.1 | Sonnet | ⏳ Pendiente — .env generator, docker-compose.prod.yml, init script |
| Deploy GCP | — | D.1 | Sonnet | ⏳ Pendiente — D.1-D.5 (último paso) |
