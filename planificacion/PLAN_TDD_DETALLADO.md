...
### Prompt 9CBis.1 — TDD RED: modelo `HubDocument` + nuevos campos en `HubChatbot` ✅ COMPLETADO

### Prompt 9CBis.2 — TDD GREEN: modelo `HubDocument`, migración Alembic y refactor de `HubDocumentChunk` ✅ COMPLETADO
...
### Prompt 9CBis.8 — Refactor de 9.7.x: `IngestionWatcher` crea `HubDocument`; chunks solo si `vector` ✅ COMPLETADO

### Prompt 9CBis.9 — Refactor UI Documentos: vista unificada de `HubDocument` + soporte multi-idioma ✅ COMPLETADO

### Prompt 9CBis.10 — Refactor de 9.8.2: SSE emite `Source[]` estructurado ✅ COMPLETADO
