...
| 74 | [`74_BLOQUE_DEP.md`](fase1/74_BLOQUE_DEP.md) | Bloque DEP — Las dependencias vulnerables, y la puerta que las vigile (COMPLETO el 2026-09-15, los 7 prompts, desplegado) |
| 75 | [`75_BLOQUE_IMG.md`](fase1/75_BLOQUE_IMG.md) | Bloque IMG — Que CI construya la imagen y la arranque (PENDIENTE, planificado el 2026-09-15 el mismo día en que el hueco tumbó producción 35 minutos; va ANTES de FUN) |
