...
**Cursor actual: IDE.2** (PLAT.1 ✅, PLAT.2 ✅ e IDE.1 ✅ el 2026-08-22; PLAT.3…PLAT.7 quedan para después de IDE) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Opus** para IDE.2 (renombra una tabla con datos y decide qué se lleva por delante).
