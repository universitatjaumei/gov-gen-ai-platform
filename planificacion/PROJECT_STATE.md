...
**Cursor actual: HIB.C** (HIB.G ▶ parcial: falta la anotación de los informadores) (actualizado el 2026-08-26; el bloque HIB se antepuso a Deploy/D.0 el 2026-08-26 y hasta hoy sólo constaba en `HISTORIAL.md`). **Modelo sugerido para el próximo prompt: Opus** (HIB.C, premisa caída: el widget no manda historial). Antes de HIB, el orden hasta el
