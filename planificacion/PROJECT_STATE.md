...
**Cursor actual: PLAT.1** (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Sonnet** para PLAT.1 (migración de datos con alcance cerrado).
