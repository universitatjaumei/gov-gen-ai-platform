...
**Cursor actual: IDE.5** (PLAT.1, PLAT.2, IDE.1…IDE.4 ✅ el 2026-08-22; PLAT.3…PLAT.7 quedan para después de IDE) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Opus** para IDE.5 (cambia el modelo de autorización de la plataforma).
