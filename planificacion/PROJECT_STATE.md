...
**Cursor actual: Bloque DOM / DOM.4.** El 2026-09-02 apareció el registro A de `normativa.uji.es`
...
primera versión había decidido no hacer. DOM.1, DOM.2 y DOM.3 ✅ el mismo día: el reparto en Caddy, el
panel bajo `/panel/` y las variables del repositorio al dominio. **Modelo sugerido para el próximo prompt: Sonnet** (DOM.4 amplía la portada y republica
las 313 páginas). Lo anterior:
