...
**Cursor actual: Bloque USR / USR.1.** **Modelo sugerido para el próximo prompt: Sonnet**
(USR.1–USR.5 y USR.7 son Sonnet; USR.6 es Opus, que decide si `HubUser` con `role='admin'` pasa a
ser la identidad de administración).
