...
**Cursor: Bloque APER — apertura del repositorio, 7 prompts. ✅ COMPLETO el 2026-09-18**, sus trece prompts (APER.1–APER.13), y **desplegado el 2026-09-19** (PR #27). Los seis últimos no estaban previstos y los trajo el propio bloque: APER.8 porque B3 era código y no consola, APER.9 porque activar Dependabot destapó que el job `supply-chain` auditaba dos locks de cuatro, APER.10 por un *flake* de 1 entre 1024, APER.11 porque la puerta de avisos bloqueó la propia PR del despliegue, **APER.12 porque la suite rota de `shared` resultó ser el 81% de un paquete muerto de AutomatIA** y APER.13 porque las trece PR de Dependabot eran inmezclables y sus grupos rebajaban versiones. Los cuatro últimos no estaban previstos y los trajo el propio bloque: APER.8 porque B3 era código y no consola, **APER.9 porque activar Dependabot destapó en trece minutos que el job `supply-chain` auditaba dos locks de cuatro**, APER.10 porque la suite completa del cierre destapó un *flake* de 1 entre 1024, y **APER.11 porque la puerta de avisos, ya con los cuatro locks, bloqueó la propia PR del despliegue** — y tenía razón. Los tres últimos no estaban previstos y los trajo el propio bloque: APER.8 porque B3 era código y no consola, **APER.9 porque activar Dependabot destapó en trece minutos que el job `supply-chain` auditaba dos locks de cuatro**, y **APER.10 porque la suite completa del cierre destapó un *flake* de 1 entre 1024** que llevaba tiempo escondido detrás del paralelismo. Los dos últimos no estaban previstos y los trajo el propio bloque: APER.8 porque B3 era código y no consola, y **APER.9 porque activar Dependabot destapó en trece minutos que el job `supply-chain` auditaba dos locks de cuatro** — y los dos que no miraba eran donde estaban los 30 avisos. El octavo se añadió sobre la marcha: B3 —los `permissions` de los workflows— estaba en el tramo «el día de abrir» por suponer que era trabajo de consola, y al preguntar el usuario si se podía desde el CLI resultó que es un cambio en el repositorio, o sea que va con su guardarraíl como todo lo demás.
