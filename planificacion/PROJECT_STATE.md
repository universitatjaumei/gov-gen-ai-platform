...
**Cursor: Bloque DEP ✅ COMPLETO en código el 2026-09-15**, los 7 prompts. **Queda una sola cosa,
y es un push**: el criterio de done de DEP.7 pide *«una ejecución real en `desarrollo` que
demuestre que bloquea cuando debe»*, y eso exige empujar. **Decisión del usuario.**
