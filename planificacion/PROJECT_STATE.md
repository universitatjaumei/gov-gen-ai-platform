...
**Cursor actual: HIB.Q** (alinear los defectos de plataforma) (HIB.G ▶ parcial: falta la anotación de los informadores) (actualizado el 2026-08-26; el bloque HIB se antepuso a Deploy/D.0 el 2026-08-26 y hasta hoy sólo constaba en `HISTORIAL.md`). **Modelo sugerido para el próximo prompt: Sonnet** (HIB.Q, alcance cerrado). Antes de HIB, el orden hasta el
