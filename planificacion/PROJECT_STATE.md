...
**Cursor actual: MT.2** (fase 1 del **Bloque MT**, con **MT.1 ✅** cerrado el 2026-08-23, que el usuario puso **antes del piloto** el 2026-08-23; los **Bloques PLAT, IDE y REV completos** ✅, y el **REV (continuación)** cerró el 2026-08-23 con REV.13) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Opus** para MT.1 — fija la regla del ámbito para todo el bloque y su guardarraíl, y de esa decisión cuelgan los seis prompts siguientes.
