...
**Cursor actual: Deploy/D.0** (la **fase 1 del Bloque MT quedó completa** el 2026-08-24 —MT.1 a MT.7—, y era lo único que el usuario puso delante del piloto; la fase 2 del bloque va después)** cerró el 2026-08-23 con REV.13) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
