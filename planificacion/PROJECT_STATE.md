...
**Cursor actual: SEC.9.1** (actualizado el 2026-08-24 tras la auditoría pre-piloto). El orden hasta el
despliegue es **SEC.9 (7 prompts) → AIS (8 prompts) → Deploy/D.0**. La auditoría de
