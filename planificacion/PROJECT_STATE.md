...
**Cursor: Bloque APER — apertura del repositorio, 7 prompts. En curso: APER.1 ✅, APER.2 ✅, APER.3 ✅, APER.4 ✅.**
...
`npm audit fix` (APER.4 ✅), el bump de `setuptools` en el lock, un `dependabot.yml` y corregir
