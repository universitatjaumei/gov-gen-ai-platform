...
**Cursor actual: PLAT.4** (PLAT.1, PLAT.2, PLAT.3 y el **Bloque IDE completo** ✅ el 2026-08-22; siguen PLAT.4…PLAT.7 y luego Deploy) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Opus** para PLAT.4 (decide qué de «Cerebro IA» sobrevive y qué era duplicado).
