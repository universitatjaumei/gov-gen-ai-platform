...
**Cursor actual: IDE.4** (PLAT.1, PLAT.2, IDE.1, IDE.2 e IDE.3 ✅ el 2026-08-22; PLAT.3…PLAT.7 quedan para después de IDE) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Sonnet** para IDE.4 (pantalla sobre endpoints ya construidos).
