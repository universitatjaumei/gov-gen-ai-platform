...
**Cursor: Bloque DEP ▶ en curso, 6 de 7.** DEP.1, DEP.2, DEP.4, DEP.5 y DEP.6 cerrados el
2026-09-10; **DEP.3 cerrado el 2026-09-15**. Queda uno:

- **DEP.7** — encender la puerta de CI (de informar a bloquear). Ya no está bloqueado: DEP.3 era
  su única dependencia y el umbral se puede fijar con la medida final encima de la mesa.
