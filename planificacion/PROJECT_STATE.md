...
**Cursor actual: HIB.B** (HIB.G ▶ parcial: falta la anotación de los informadores) (actualizado el 2026-08-26; el bloque HIB se antepuso a Deploy/D.0 el 2026-08-26 y hasta hoy sólo constaba en `HISTORIAL.md`). **Modelo sugerido para el próximo prompt: Opus** (HIB.B, dos decisiones abiertas). Antes de HIB, el orden hasta el
