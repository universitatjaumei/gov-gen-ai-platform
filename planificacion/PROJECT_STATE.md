...
**Cursor actual: MT.1** (fase 1 del **Bloque MT**, que el usuario puso **antes del piloto** el 2026-08-23; los **Bloques PLAT, IDE y REV completos** ✅, y el **REV (continuación)** cerró el 2026-08-23 con REV.13) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
