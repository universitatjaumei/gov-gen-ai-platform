...
**Cursor actual: Bloque DOM / DOM.3.** El 2026-09-02 apareció el registro A de `normativa.uji.es`
...
primera versión había decidido no hacer. DOM.1 y DOM.2 ✅ el mismo día: el reparto en Caddy y el
panel bajo `/panel/`. **Modelo sugerido para el próximo prompt: Sonnet** (DOM.3 cambia variables
del repositorio y comprueba que las citas resuelven). Lo anterior:
