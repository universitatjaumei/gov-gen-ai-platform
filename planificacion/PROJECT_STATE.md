...
**Cursor actual: sin bloque en curso.** El **Bloque USR ✅ quedó completo el 2026-09-03** (7
prompts): una persona de `hub_users` puede tener contraseña local, entrar con su rol real, que se
