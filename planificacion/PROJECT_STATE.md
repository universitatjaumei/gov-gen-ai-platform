...
**Cursor actual: MT.3** (fase 1 del **Bloque MT**, con **MT.1 y MT.2 ✅** cerrados, que el usuario puso **antes del piloto** el 2026-08-23; los **Bloques PLAT, IDE y REV completos** ✅, y el **REV (continuación)** cerró el 2026-08-23 con REV.13) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
