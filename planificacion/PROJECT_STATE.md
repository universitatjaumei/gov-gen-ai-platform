...
**Siguiente por el orden acordado el 2026-09-02: Bloque REG** (6 prompts, Sonnet salvo REG.4).
Después VAS → NIC → REPO → PLG → DIN → FUN, con PRC en paralelo y a tandas. **LANG ✅ quedó
completo el 2026-09-03** y está en `desarrollo`, **sin desplegar**: el paso a `main` es decisión
del usuario. Lo anterior:
