...
**Cursor actual: IDE.3** (PLAT.1 ✅, PLAT.2 ✅, IDE.1 ✅ e IDE.2 ✅ el 2026-08-22; PLAT.3…PLAT.7 quedan para después de IDE) (y de ahí a PLAT.2 → IDE.1…IDE.5 → PLAT.3…PLAT.7 → Deploy). El **Bloque INF quedó completo** el 2026-08-20 (los 10
...
**Modelo sugerido para el próximo prompt**: **Opus** para IDE.3 (el cruce entre alta manual y aprovisionamiento automático).
