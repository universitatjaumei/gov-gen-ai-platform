...
**Cursor actual: Bloque DOM / DOM.2.** El 2026-09-02 apareció el registro A de `normativa.uji.es`
...
primera versión había decidido no hacer. **Modelo sugerido para el próximo prompt: Opus** (DOM.2
toca compilación, router y nginx a la vez; es la parte con riesgo del bloque). Lo anterior:
