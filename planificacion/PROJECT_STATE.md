...
**Cursor actual: HIB.D** (rama de Gerencia; HIB.G ▶ espera anotación) (HIB.G ▶ parcial: falta la anotación de los informadores) (actualizado el 2026-08-26; el bloque HIB se antepuso a Deploy/D.0 el 2026-08-26 y hasta hoy sólo constaba en `HISTORIAL.md`). **Modelo sugerido para el próximo prompt: Sonnet** (HIB.D, alcance cerrado con paso 0). Antes de HIB, el orden hasta el
