...
**Cursor actual: Bloque USR / USR.6.** **Modelo sugerido para el próximo prompt: Opus**
(USR.6 decide si `HubUser` con `role='admin'` pasa a
ser la identidad de administración).
